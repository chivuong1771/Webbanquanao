...
<%@ page import="java.util.*, com.clothingstore.entity.*" %>
...
<%
    ...
    if (product != null && product.getVariants() != null) {
        for (ProductDetail d : product.getVariants()) {
    ...
    <div class="detail-container">
            ...
            <div class="main-image">
                <c:choose>
                    <c:when test="${not empty product.primaryImage}">
                        <img src="${product.primaryImage.startsWith('http') ? product.primaryImage : pageContext.request.contextPath.concat('/').concat(product.primaryImage)}" alt="${product.name}">
                    </c:when>
                    <c:otherwise>
                        <img src="${pageContext.request.contextPath}/assets/images/placeholder.jpg" alt="${product.name}">
                    </c:otherwise>
                </c:choose>
            </div>
        ...
        <div class="detail-info">
            <div>
                ...
                <h1 class="detail-title" style="margin-top: 6px; margin-bottom: 12px;">${product.name}</h1>
